...
2. **PR 본문**: PR 템플릿 형식과 주석에 맞춰 자연스럽고 간결한 한국어로 작성합니다.
  ...
  - "## Merge Commit 제목"에는 PR 제목과 동일하게 작성합니다.
    - 앞에 "Merge PR #${prNumber}: "을 붙여서 작성합니다. (예: Merge PR #123: feat: 새로운 기능 추가)
    - 뒤에 "(수정중)"을 제거하여 작성합니다.
    ...
    messages: [
      {
        role: "developer",
        content:
          "GitHub Pull Request 내용을 생성하는 어시스턴트입니다. 입력된 정보를 바탕으로 제목과 본문을 작성하세요. 출력 형식은 제목과 본문 형식을 따르세요.",
      },
      {
        role: "user",
        content: prompt,
